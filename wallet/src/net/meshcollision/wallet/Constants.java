...
package net.meshcollision.wallet;
...
public final class Constants
{
	...
	public static final String SOURCE_URL = "https://github.com/MeshCollider/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
	public static final String BINARY_URL = "https://github.com/MeshCollider/"+ CoinDefinition.coinName.toLowerCase() +"-wallet/releases";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/MeshCollider/" + CoinDefinition.coinName.toLowerCase() + "j";
