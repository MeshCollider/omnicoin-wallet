...
import net.meshcollision.wallet.util.Io;
import net.meshcollision.wallet.util.PaymentProtocol;
import net.meshcollision.wallet.util.Qr;

import com.google.bitcoin.core.CoinDefinition;
import net.meshcollision.wallet.omnicoin.R;
...
public abstract class InputParser
{
	...
	private static final Pattern PATTERN_PRIVATE_KEY_UNCOMPRESSED = Pattern.compile(CoinDefinition.PATTERN_PRIVATE_KEY_START + "[" + new String(Base58.ALPHABET) + "]{50}");
	private static final Pattern PATTERN_PRIVATE_KEY_COMPRESSED = Pattern.compile(CoinDefinition.PATTERN_PRIVATE_KEY_START_COMPRESSED + "[" + new String(Base58.ALPHABET) + "]{51}");
